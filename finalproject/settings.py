...
ADMINS = (
     ('Anuj Patel', 'anujp@andrew.cmu.edu'),
     ('Vijay Jayaram', 'vijayj@andrew.cmu.edu')
)
...
SECRET_KEY = 'mf57(fmoe_vcvt^97q)x+)15x_l(sx3=om+p^x%!04oqrkstnj'
...
LOGIN_URL = '/authenticate/index.html'

# Default URL to redirect to after a user logs in.
LOGIN_REDIRECT_URL = '/feed/index.html'
